...
describe "beerlist page" do
  ...
  it "first shows beers in order by name", js: true do
    visit beerlist_path
  ...
  it "orders beers by style when style is clicked", js: true do
    visit beerlist_path
    click_link "Style"
  ...
  it "orders beers by brewery when brewery is clicked", js: true do
    visit beerlist_path
    click_link "Brewery"
